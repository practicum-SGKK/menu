		...
		void InitializeComponent(void)
		{
			...
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3)
			{
				this->çàãğóçèòüToolStripMenuItem,
					this->ôîğìàòToolStripMenuItem, this->âûâîäToolStripMenuItem
			});
			...
			this->çàãğóçèòüToolStripMenuItem->Size = System::Drawing::Size(94, 24);
			...
			this->ôàéë1ToolStripMenuItem->Size = System::Drawing::Size(139, 26);
			...
			this->ôàéë2ToolStripMenuItem->Size = System::Drawing::Size(139, 26);
			this->ôàéë2ToolStripMenuItem->Text = L"ôàéë 2";
			this->ôàéë2ToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::ôàéë2ToolStripMenuItem_Click);
			// 
			...
			this->ôîğìàòToolStripMenuItem->Size = System::Drawing::Size(76, 24);
			this->ôîğìàòToolStripMenuItem->Text = L"ôîğìàò";
			// 
			// øğèôòToolStripMenuItem
			// 
			this->øğèôòToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(10) 
			{
			...
			this->ïîëóæèğíûéToolStripMenuItem->Size = System::Drawing::Size(216, 26);
			...
			this->êóğñèâToolStripMenuItem->Size = System::Drawing::Size(216, 26);
			...
			this->ïîä÷åğêíóòûéToolStripMenuItem->Size = System::Drawing::Size(216, 26);
			...
			this->âûğàâíèâàíèåToolStripMenuItem->Size = System::Drawing::Size(224, 26);
			...
			this->ïîÖåíòğóToolStripMenuItem->Size = System::Drawing::Size(224, 26);
			...
			this->ïîÏğàâîìóÊğàşToolStripMenuItem->Size = System::Drawing::Size(224, 26);
			this->ïîÏğàâîìóÊğàşToolStripMenuItem->Text = L"Ïî ïğàâîìó êğàş";
			this->ïîÏğàâîìóÊğàşToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::ïîÏğàâîìóÊğàşToolStripMenuItem_Click);
			// 
			// ïîËåâîìóÊğàşToolStripMenuItem
			// 
			this->ïîËåâîìóÊğàşToolStripMenuItem->Name = L"ïîËåâîìóÊğàşToolStripMenuItem";
			this->ïîËåâîìóÊğàşToolStripMenuItem->Size = System::Drawing::Size(224, 26);
			this->ïîËåâîìóÊğàşToolStripMenuItem->Text = L"Ïî ëåâîìó êğàş";
			this->ïîËåâîìóÊğàşToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::ïîËåâîìóÊğàşToolStripMenuItem_Click);
			// 
			// âûâîäToolStripMenuItem
			// 
			this->âûâîäToolStripMenuItem->Name = L"âûâîäToolStripMenuItem";
			this->âûâîäToolStripMenuItem->Size = System::Drawing::Size(67, 24);
...
#pragma endregion
	private: System::Void ôàéë1ToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		System::IO::StreamReader("C:\\Users\\Êñåíèÿ\\Desktop\\menu1\\text1.txt"); //çäåñü óêàçûâàåì ëşáîé ïóòü
		System::String^ text = sr->ReadToEnd(); //ñ÷èòûâåì ôàéë â text
		textBox1->Text = text;//çàïèñûâàåì â textbox çíà÷åíèå ïåğåìåíîé text
		sr->Close(); //çàêğûòèå ôàéëà
	}
	...
	private: System::Void ôàéë2ToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
	{
		System::IO::StreamReader^ sr = gcnew System::IO::StreamReader("C:\\Users\\Êñåíèÿ\\Desktop\\menu1\\text2.txt"); //çäåñü óêàçûâàåì ëşáîé ïóòü
		System::String^ text = sr->ReadToEnd(); //ñ÷èòûâåì ôàéë â text
		textBox2->Text = text;//çàïèñûâàåì â textbox çíà÷åíèå ïåğåìåíîé text
		sr->Close(); //çàêğûòèå ôàéëà
	}
	...
	private: System::Void ïîÏğàâîìóÊğàşToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) 
	{
		textBox1->TextAlign = HorizontalAlignment::Right;
		textBox2->TextAlign = HorizontalAlignment::Right;
	}
	private: System::Void ïîËåâîìóÊğàşToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) 
	{
